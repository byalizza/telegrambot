...
const API = {
  ...
  setCWallet: (cwalletId) => api('/wallet/set-cwallet', { method: 'POST', body: JSON.stringify({ cwalletId }) }),
  withdraw: (amountGold, cwalletId) => api('/wallet/withdraw', { method: 'POST', body: JSON.stringify({ amountGold, cwalletId }) }),
